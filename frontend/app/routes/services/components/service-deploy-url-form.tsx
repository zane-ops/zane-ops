      ...
      >
        <fieldset className="w-full flex flex-col gap-5">
          ...
          <p className="text-gray-400">
            ...
            &nbsp;of this service (e.g. from a CI/CD pipeline). Remember to keep
            this a secret.
          </p>
...
export function ServicePreviewDeployURLForm({
  project_slug,
  service_slug,
  env_slug
}: ServiceDeployURLFormProps) {
  ...
  return (
    <div className="w-full max-w-4xl">
      ...
      >
        <fieldset className="w-full flex flex-col gap-5">
          <legend className="text-lg">Preview Deploy webhook URL</legend>
          <p className="text-gray-400">
            Your private URL to&nbsp;
            <a
              ...
              className="text-link underline inline-flex gap-1 items-center"
            >
              trigger a preview deployment <ExternalLinkIcon size={12} />
            </a>
            &nbsp;of this service (e.g. from a CI/CD pipeline). Remember to keep
            this a secret.
          </p>
