  ...
  "fixed z-100 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 left-0 h-full w-[90%] border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left md:max-w-md",
        right:
          "inset-y-0 right-0 h-full w-[90%]  border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right md:max-w-md"
      }
    },
    defaultVariants: {
      side: "bottom"
...
function SheetContent({
  ...
  return (
    <SheetPortal>
      <SheetOverlay id={`sheet-overlay-${id}`} className="z-99" />
