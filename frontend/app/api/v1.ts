...
export interface paths {
  ...
  "/api/workspace/invitations/{id}/delete/": {
    delete: operations["workspace_invitations_delete_destroy"];
  };
  "/api/workspace/invitations/{id}/regenerate/": {
    /** Regenerate user invitation link in workspace */
    put: operations["regenerateUserInvitation"];
  };
...
export interface components {
  schemas: {
    ...
    ComposeStackDeployRequestRequest: {
      /** @default Update stack */
      commit_message?: string;
    };
    ComposeStackDeployment: {
      hash: string;
      status: components["schemas"]["ComposeStackDeploymentStatusEnum"];
      status_reason: string | null;
      stack_snapshot: components["schemas"]["ComposeStackSnapshot"];
      commit_message: string;
      /** Format: date-time */
      queued_at: string;
      /** Format: date-time */
    ...
    ComposeStacksUpdateSlugErrorComponent: {
      /**
       * @description * `slug` - slug
       * @enum {string}
       */
    ...
    ComposeStacksUpdateValidationError: {
      type: components["schemas"]["ValidationErrorEnum"];
      errors: components["schemas"]["ComposeStacksUpdateError"][];
    };
    Config: {
      id: string;
      name: string;
    ...
    DeployComposeStackValidationError: {
      type: components["schemas"]["ValidationErrorEnum"];
      errors: components["schemas"]["DeployComposeStackError"][];
    };
    ...
    LeaveWorkspaceError:
      | components["schemas"]["LeaveWorkspaceNonFieldErrorsErrorComponent"]
      | components["schemas"]["LeaveWorkspaceSuccessErrorComponent"];
    LeaveWorkspaceErrorResponse400:
      | components["schemas"]["LeaveWorkspaceValidationError"]
      | components["schemas"]["ParseErrorResponse"];
    ...
    RegenerateUserInvitationValidForErrorComponent: {
      /**
       * @description * `valid_for` - valid_for
       * @enum {string}
       */
    ...
    RegenerateUserInvitationValidationError: {
      type: components["schemas"]["ValidationErrorEnum"];
      errors: components["schemas"]["RegenerateUserInvitationError"][];
    };
    RegenerateWorkspaceInvitationRequestRequest: {
      /** @default 3 */
      valid_for?: components["schemas"]["ValidForEnum"];
    };
    ...
    RegisterUserIntoWorkspacePasswordErrorComponent: {
      /**
       * @description * `password` - password
       * @enum {string}
       */
    ...
    RequestServiceChangesNewValueVolumeIdErrorComponent: {
      /**
       * @description * `new_value.volume_id` - new_value.volume_id
       * @enum {string}
       */
      attr: "new_value.volume_id";
      /**
       * @description * `blank` - blank
       * * `invalid` - invalid
       * * `max_length` - max_length
    ...
    SharedVolume: {
      id: string;
      volume: components["schemas"]["VolumeWithService"];
      volume_id: string;
      container_path: string;
    };
    /**
     * @description * `shared_volumes` - shared_volumes
     * @enum {string}
     */
    SharedVolumeItemChangeFieldEnum: "shared_volumes";
    SharedVolumeItemChangeRequest: {
      type: components["schemas"]["ItemChangeTypeEnum"];
      item_id?: string;
      new_value?: components["schemas"]["SharedVolumeRequestRequest"];
      field: components["schemas"]["SharedVolumeItemChangeFieldEnum"];
    };
    SharedVolumeRequest: {
      id?: string;
      container_path: string;
    };
    SharedVolumeRequestRequest: {
      volume_id: string;
      container_path: string;
    };
...
export interface operations {
  ...
  getComposeStackDetails: {
    ...
    responses: {
      200: {
        content: {
          "application/json": components["schemas"]["ComposeStackUpdate"];
        };
      };
      400: {
        content: {
  ...
  compose_stacks_update: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ComposeStackUpdateRequest"];
        "application/x-www-form-urlencoded": components["schemas"]["ComposeStackUpdateRequest"];
        "multipart/form-data": components["schemas"]["ComposeStackUpdateRequest"];
      };
    };
    responses: {
      200: {
  ...
  deployComposeStack: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ComposeStackDeployRequestRequest"];
        "application/x-www-form-urlencoded": components["schemas"]["ComposeStackDeployRequestRequest"];
        "multipart/form-data": components["schemas"]["ComposeStackDeployRequestRequest"];
      };
    };
    responses: {
      200: {
      ...
      400: {
        content: {
          "application/json": components["schemas"]["DeployComposeStackErrorResponse400"];
        };
      };
      401: {
        content: {
  ...
  getRegistryCredentials: {
    responses: {
      ...
      400: {
        content: {
          "application/json": components["schemas"]["GetRegistryCredentialsErrorResponse400"];
        };
      };
      401: {
        content: {
  ...
  registries_credentials_create: {
    ...
    responses: {
      ...
      400: {
        content: {
          "application/json": components["schemas"]["RegistriesCredentialsCreateErrorResponse400"];
        };
      };
      401: {
        content: {
  ...
  registries_credentials_retrieve: {
    parameters: {
      path: {
        id: string;
      };
  ...
  deleteRegistryCredentials: {
    ...
    responses: {
      ...
      400: {
        content: {
          "application/json": components["schemas"]["DeleteRegistryCredentialsErrorResponse400"];
        };
      };
      401: {
        content: {
  ...
  workspace_invitations_delete_destroy: {
    parameters: {
      path: {
        id: string;
      };
    ...
    responses: {
      ...
      400: {
        content: {
          "application/json": components["schemas"]["WorkspaceInvitationsDeleteDestroyErrorResponse400"];
        };
      };
      401: {
        content: {
  ...
  regenerateUserInvitation: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["RegenerateWorkspaceInvitationRequestRequest"];
        "application/x-www-form-urlencoded": components["schemas"]["RegenerateWorkspaceInvitationRequestRequest"];
        "multipart/form-data": components["schemas"]["RegenerateWorkspaceInvitationRequestRequest"];
      };
    };
    responses: {
      200: {
      ...
      400: {
        content: {
          "application/json": components["schemas"]["RegenerateUserInvitationErrorResponse400"];
        };
      };
      401: {
        content: {
  ...
  workspace_invitations_retrieve: {
    ...
    responses: {
      200: {
        content: {
          "application/json": components["schemas"]["WorkspaceInvitationLink"];
        };
      };
      400: {
        content: {
  ...
  inviteUser: {
    requestBody: {
      content: {
        "application/json": components["schemas"]["InviteUserIntoWorkspaceRequestRequest"];
        "application/x-www-form-urlencoded": components["schemas"]["InviteUserIntoWorkspaceRequestRequest"];
        "multipart/form-data": components["schemas"]["InviteUserIntoWorkspaceRequestRequest"];
      };
    };
    responses: {
      200: {
  ...
  registerUserIntoWorkspace: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["WorkspaceRegisterRequestRequest"];
        "application/x-www-form-urlencoded": components["schemas"]["WorkspaceRegisterRequestRequest"];
        "multipart/form-data": components["schemas"]["WorkspaceRegisterRequestRequest"];
      };
    };
    responses: {
      201: {
      ...
      400: {
        content: {
          "application/json": components["schemas"]["RegisterUserIntoWorkspaceErrorResponse400"];
        };
      };
      401: {
        content: {
