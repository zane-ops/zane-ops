...
5. `ROOT_DOMAIN`: Used to generate subdomains for deployed web apps, e.g., `my-web-app.zaneops.local`. The root domain itself can also host the dashboard if desired.
